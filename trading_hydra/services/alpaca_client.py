...
class AlpacaClient:
    def __init__(self):
        ...
        # API rate limiter: ~2 requests per second (Alpaca free tier = 200/min)
        # This lock is shared across ALL threads and ALL API methods (REST + SDK)
        self._rate_lock = threading.Lock()
        self._last_request_time: float = 0.0
        self._min_request_interval: float = 0.35  # 350ms between API calls (~3/sec)
    ...
    def _throttle(self):
        """Global rate limiter - call before ANY Alpaca API request (REST or SDK)."""
